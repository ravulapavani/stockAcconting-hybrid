...
public class Functionlibrary {
	...
	public static WebDriver startBrowser() throws Exception{
		if(PropertyfileUtil.getvalueForKey("Browser").equalsIgnoreCase("chrome")){
			System.setProperty("webdriver.chrome.driver", "D:\\pavani_82\\StockAccounting_Hybrid\\drivers\\chromedriver.exe");
			driver=new ChromeDriver();
			
		}else if(PropertyfileUtil.getvalueForKey("Browser").equalsIgnoreCase("firefox")){
			
			System.setProperty("webdriver.gecko.driver", "D:\\pavani_82\\StockAccounting_Hybrid\\drivers\\geckodriver.exe");
			driver=new FirefoxDriver();
		}else{
			System.setProperty("webdriver.i.e.driver", "D:\\pavani_82\\StockAccounting_Hybrid\\drivers\\IEDriverServer.exe");
	...
	public static void clickAction(WebDriver driver,String locatortype,String locatorvalue){
		 if(locatortype.equalsIgnoreCase("id")){
			 ...
			 {
				 System.out.println("unable to locate for clickAction method with"+locatortype);
			 }
	}
	...
	public static void captureData(WebDriver driver,String locatortytpe,
		...
		FileWriter fw=new FileWriter ("D:\\pavani_82\\StockAccounting_Hybrid\\CaptureData\\suppliernumber.txt");
